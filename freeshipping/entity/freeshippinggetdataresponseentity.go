...
type FreeShippingGetDataResponseEntity struct{
    ...
    PromoTier	FreeShippingGetPromoTierResponseEntity	`json:"promo_tier"`
    Status	string	`json:"status"`
}
func (g FreeShippingGetDataResponseEntity) String() string {
